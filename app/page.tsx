  ...
  const FeatureScreen = ({ type }: { type: string }) => (
    <div className="mt-4 max-w-[220px] overflow-hidden rounded-lg border border-black/[0.08] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
      <div className="flex items-center gap-1.5 border-b border-black/[0.06] bg-[#f0eeea] px-2.5 py-1.5">
        ...
        <span className="ml-1 text-micro text-[#999]">Yonder</span>
      </div>
      <div className="min-h-[100px] p-2.5 text-micro">
        {type === "layers" && (
        ...
        {type === "verdict" && (
          <div className="pdf-scan-container relative space-y-1.5 rounded-md bg-[#f8f7f4] p-2">
            ...
            <div className="relative mt-1.5 rounded bg-[#4a9a4a]/15 px-2 py-1 text-micro font-medium text-[#2d7a2d]">Verdict: Viable ✓</div>
          </div>
        )}
        {type === "search" && (
          <div className="space-y-1.5">
            ...
            <div className="flex items-center justify-between text-overline">
        ...
        {type === "predict" && (
          <div className="space-y-2 rounded-md bg-[#f8f7f4] p-2">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-overline font-medium text-[#1a1a18]">Matching demand…</div>
          ...
          <div className="rounded-md border border-black/[0.06] bg-[#fafafa] p-2">
            <div className="flex items-center gap-2">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-baseline gap-0.5 text-micro font-medium text-[#1a1a18]">
                  Understanding
  ...
  return (
    <div className="relative min-h-screen bg-[#F9F9F9] text-[#1a1a18] font-sans overflow-x-hidden">
      ...
      <div className="relative overflow-hidden pb-14 pt-16 sm:pt-20 lg:pb-16 lg:pt-24">
        ...
        <p className="mb-8 max-w-[520px] text-body leading-[1.6] text-[#6b6b68]">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <Link href="/explorer" className="inline-flex items-center gap-2 rounded-full border-none bg-[#1a1a18] px-6 py-2.5 text-body-sm font-medium text-white no-underline">
            Search land →
          </Link>
          <a href="#product" className="rounded-full border border-black/[0.15] px-5 py-2.5 text-body-sm font-medium text-[#6b6b68] no-underline transition-colors hover:border-black/[0.25] hover:text-[#1a1a18]">See how it works →</a>
        </div>
      </div>
            ...
            <div className="grid min-h-[520px] grid-cols-1 md:grid-cols-[380px_1fr]">
              ...
              <div className="flex flex-col border-r border-black/[0.08] bg-[#F5F5F5]">
                <div className="border-b border-black/[0.06] px-5 py-4">
                  <span className="text-caption font-semibold uppercase tracking-[0.1em] text-[#888]">Your Project</span>
                </div>
                {/* Area search bar — links sidebar to map */}
                <div className="border-b border-black/[0.08] bg-white px-4 py-3">
                  <div className="flex items-center justify-between gap-2">
                    <div>
                      <div className="text-nav font-medium text-[#1a1a18]">Area search Alentejo</div>
                      <div className="text-caption text-[#6b6b68]">120 plots · Analyze all</div>
                    </div>
                    <button className="shrink-0 rounded-md bg-[#1a1a18] px-3 py-1.5 text-caption font-medium text-white">Analyze</button>
                  </div>
                </div>
                <div className="flex flex-1 flex-col overflow-y-auto px-4 py-5">
                  {/* IN PROGRESS — thin circle spinner with orange segment */}
                  <div className="mb-5">
                    <div className="mb-4 text-overline font-semibold uppercase tracking-[0.14em] text-[#999]">In progress 2</div>
                    {[
                      ...
                      <div key={i} className="mb-4 flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="text-body-sm font-semibold text-[#1a1a18]">{item.title}</div>
                          <div className="text-app-secondary text-[#6b6b68]">{item.subtitle}</div>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div>
                    <div className="mb-4 text-overline font-semibold uppercase tracking-[0.14em] text-[#999]">Ready for review 4</div>
                    {[
                      ...
                      <div key={i} className={`mb-3 flex cursor-pointer items-start gap-3 rounded-lg px-3 py-3 transition-colors hover:bg-black/[0.04] ${item.selected ? "bg-black/[0.04]" : ""}`}>
                        ...
                        <div className="shrink-0 pt-0.5 text-caption text-[#999]">{item.time}</div>
                      </div>
                    ))}
                  </div>
                </div>
                <div className="border-t border-black/[0.06] p-4">
                  <div className="flex items-center gap-2 rounded-lg border border-black/[0.08] bg-white px-4 py-2.5">
                    <input type="text" placeholder="Ask about this area…" className="flex-1 bg-transparent text-nav text-[#1a1a18] placeholder:text-[#999] focus:outline-none" />
                    <button className="rounded-full bg-[#1a1a18] px-3 py-1 text-caption font-medium text-white">+</button>
                  </div>
                </div>
              </div>
              {/* Right: Map panel */}
              <div className="flex flex-col bg-white">
                <div className="flex items-center gap-3 border-b border-black/[0.06] px-5 py-3.5">
                  <div className="flex flex-1 items-center gap-2 rounded-[10px] bg-[#1a1a18] px-4 py-2.5">
                    ...
                    <span className="text-nav text-white/90">Find Land</span>
                  </div>
                  <button className="flex items-center gap-1.5 rounded-[8px] border border-black/[0.12] bg-white px-3 py-2 text-app-secondary font-medium text-[#1a1a18]">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>
                    Your Project
                  </button>
                </div>
                <div className="flex items-center gap-2 border-b border-black/[0.06] px-5 py-2.5">
                  <button className="rounded-md bg-black/[0.06] px-3 py-1.5 text-caption font-medium text-[#1a1a18]">Map</button>
                  <button className="rounded-md px-3 py-1.5 text-caption font-medium text-[#888] hover:bg-black/[0.03]">List</button>
                  <button className="rounded-md px-3 py-1.5 text-caption font-medium text-[#888] hover:bg-black/[0.03]">Filters</button>
                  <div className="ml-2 flex flex-wrap gap-1.5">
                    <span className="flex items-center gap-1 rounded-full bg-[#f0f0f0] px-2.5 py-1 text-overline text-[#666]">
                ...
                <div className="flex items-center justify-between px-5 py-2.5">
                  <span className="text-app-secondary font-medium text-[#1a1a18]">120 plots in drawn area</span>
                  <button className="rounded-md border border-black/[0.12] px-3 py-1.5 text-caption font-medium text-[#1a1a18]">Select Plots</button>
                </div>
                <div className="relative flex-1 overflow-hidden bg-[#e8e8e8]">
                  ...
                  {[
                    ...
                    <div
                      key={m.num}
                      className="absolute flex h-10 w-10 items-center justify-center rounded-full bg-[#3B82F6] text-app-secondary font-semibold text-white shadow-[0_2px_8px_rgba(59,130,246,0.4)]"
                  ...
                  <div className="absolute bottom-4 left-4 flex flex-col gap-1 rounded-lg border border-black/[0.08] bg-white/95 shadow-sm">
                    <button className="flex items-center gap-2 rounded-t-lg px-3 py-2.5 text-caption font-medium text-[#555] hover:bg-black/[0.03]">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>
                      Pin
                    </button>
                    <button className="flex items-center gap-2 rounded-md border border-[#c84b0a]/30 bg-[#c84b0a]/10 px-3 py-2.5 text-caption font-medium text-[#c84b0a]">
                    ...
                    <button className="flex items-center justify-between gap-2 rounded-b-lg px-3 py-2.5 text-caption font-medium text-[#555] hover:bg-black/[0.03]">
                  ...
                  <div className="absolute right-4 top-4 rounded-lg border border-black/[0.06] bg-white/95 px-3 py-2 text-caption text-[#555] shadow-sm">
      ...
      <div id="product" className="relative py-14 lg:py-20">
        <div className="mb-3 text-overline font-semibold uppercase tracking-[0.12em] text-[#c84b0a]">Product</div>
        ...
        <p className="mb-10 max-w-[520px] text-body leading-[1.6] text-[#6b6b68]">
        ...
        <div className="relative">
          ...
          <div className="pointer-events-none absolute inset-0 hidden lg:block" aria-hidden>
            ...
            <div className="absolute left-[16.67%] top-1/2 -translate-x-1/2 -translate-y-1/2">
              <span className="rounded border border-black/[0.06] bg-[#F9F9F9] px-2 py-0.5 font-mono text-micro font-medium tracking-wider text-[#c84b0a]/70">Land use</span>
            </div>
            <div className="absolute left-[50%] top-1/2 -translate-x-1/2 -translate-y-1/2">
              <span className="rounded border border-black/[0.06] bg-[#F9F9F9] px-2 py-0.5 font-mono text-micro font-medium tracking-wider text-[#c84b0a]/70">Registry</span>
            </div>
            <div className="absolute left-[83.33%] top-1/2 -translate-x-1/2 -translate-y-1/2">
              <span className="rounded border border-black/[0.06] bg-[#F9F9F9] px-2 py-0.5 font-mono text-micro font-medium tracking-wider text-[#c84b0a]/70">Zoning</span>
            </div>
          </div>
        <div className="grid grid-cols-1 gap-4 overflow-visible md:grid-cols-2 lg:grid-cols-3">
          {features.map((f) => (
            <div key={f.num} className="cadastral-block relative z-10 flex flex-col bg-[#F9F9F9] p-6 lg:p-7">
              <span className="absolute right-4 top-4 font-mono text-micro font-semibold tracking-wider text-black/20">PT-{f.num}</span>
              <div className="mb-2 text-display font-medium leading-none tracking-[-0.02em] text-[#ccc] sm:text-[2rem]">{f.num}</div>
              <div className="mb-2 text-body font-medium leading-snug text-[#1a1a18]">{f.title}</div>
              <div className="text-body-sm leading-[1.55] text-[#6b6b68]">{f.desc}</div>
      ...
      <div id="who" className="relative py-14 lg:py-20">
        <div className="mb-3 text-overline font-semibold uppercase tracking-[0.12em] text-[#c84b0a]">For who</div>
        ...
        <div className="grid grid-cols-1 gap-[1px] overflow-hidden rounded-[10px] border border-black/[0.12] bg-black/[0.08] md:grid-cols-2 lg:grid-cols-5" style={{ boxShadow: "inset 0 0 0 1px rgba(0,0,0,0.06)" }}>
          {whoFor.map((w, i) => (
            <div key={w.title} className="cadastral-block relative flex flex-col gap-3 bg-[#F9F9F9] p-5 lg:p-6">
              <span className="absolute right-3 top-3 font-mono text-micro font-semibold tracking-wider text-black/20">PDM-{(i + 1).toString().padStart(2, "0")}</span>
              ...
              <div className="text-body-sm font-medium text-[#1a1a18]">{w.title}</div>
              <div className="text-nav leading-[1.5] text-[#6b6b68]">{w.desc}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div id="coverage" className="py-14 lg:py-20">
        ...
        <h2 className="text-h2 mb-3 text-[#1a1a18]">
          Portugal live. <em>Europe next.</em>
            ...
            <p className="mb-8 text-body leading-[1.6] text-[#6b6b68]">
              ...
              {coverage.map((c) => (
                <div key={c.region} className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-body-sm font-medium text-[#1a1a18]">{c.region}</span>
                  </div>
                  <span className={`rounded-full px-3 py-1 text-overline font-semibold uppercase tracking-[0.08em] ${c.active ? "bg-[#3B82F6]/15 text-[#3B82F6]" : "bg-[#f0f0f0] text-[#6b6b68]"}`}>
                    {c.status}
                  </span>
                </div>
              ))}
          ...
          <div className="relative overflow-hidden rounded-[10px] border border-black/[0.08] bg-[#e8eef4] cadastral-lines">
            ...
            <div className="absolute bottom-4 left-4 right-4 flex gap-4 rounded-md border border-black/[0.06] bg-white/90 px-3 py-2">
              <span className="flex items-center gap-1.5 text-overline text-[#6b6b68]"><span className="h-1.5 w-1.5 rounded-full bg-[#3B82F6]" /> Live</span>
              <span className="flex items-center gap-1.5 text-overline text-[#6b6b68]"><span className="h-1.5 w-1.5 rounded-full border border-[#3B82F6] bg-[#3B82F6]/20" /> Next</span>
              <span className="flex items-center gap-1.5 text-overline text-[#6b6b68]"><span className="h-1.5 w-1.5 rounded-full border border-[#ccc] bg-transparent" /> Planned</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 overflow-hidden rounded-[10px] border border-black/[0.08] bg-[#1a1a18] p-6 lg:p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
            <div>
              ...
              <p className="max-w-[480px] text-body leading-[1.6] text-white/70">
            ...
            <div className="flex shrink-0 flex-col gap-3 sm:flex-row">
              <a href="#" className="rounded-full bg-white px-6 py-2.5 text-center text-body-sm font-medium text-[#1a1a18] no-underline hover:bg-white/90">Become a partner</a>
              <a href="mailto:hello@liveyonder.co" className="rounded-full border border-white/30 px-6 py-2.5 text-center text-body-sm font-medium text-white no-underline hover:border-white/50">hello@liveyonder.co</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="pricing" className="relative py-14 lg:py-20">
        ...
        <div className="mb-12 grid grid-cols-1 gap-px overflow-hidden rounded-[10px] border border-black/[0.08] bg-black/[0.08] sm:grid-cols-2 md:grid-cols-4">
          <div className="bg-[#F9F9F9] p-5">
            <div className="mb-0.5 text-nav font-medium text-[#1a1a18]">Browse & search</div>
            <div className="text-h3 font-medium text-[#1a1a18]">Free</div>
          </div>
          <div className="bg-[#F9F9F9] p-5">
            <div className="mb-0.5 text-nav font-medium text-[#1a1a18]">Zoning check</div>
            <div className="text-h3 font-medium text-[#1a1a18]">1 token</div>
          </div>
          <div className="bg-[#F9F9F9] p-5">
            <div className="mb-0.5 text-nav font-medium text-[#1a1a18]">Full AI report</div>
            <div className="text-h3 font-medium text-[#1a1a18]">10 tokens</div>
          </div>
          <div className="bg-[#F9F9F9] p-5">
            <div className="mb-0.5 text-nav font-medium text-[#1a1a18]">Off-market discovery</div>
            <div className="text-h3 font-medium text-[#1a1a18]">20 tokens</div>
          </div>
        </div>
        ...
        <div className="relative mb-12 overflow-hidden rounded-[10px] border border-emerald-200/60 bg-emerald-50/80 p-6">
          ...
          <h3 className="mb-1.5 text-h3 font-medium text-emerald-800">Free for land owners</h3>
          <p className="mb-2 text-body-sm leading-[1.5] text-emerald-800/90">
            You own land. Find out what it&apos;s worth.
          </p>
          <p className="mb-4 text-nav leading-[1.5] text-emerald-900/75">
            Free plot analysis — zoning, building rights, permitted uses. We only earn when your land sells.
          </p>
          <div className="flex flex-wrap gap-3">
            <Link href="/explorer" className="rounded-full border border-emerald-600/50 bg-emerald-600 px-4 py-2 text-nav font-medium text-white no-underline transition-colors hover:bg-emerald-700">Sign up</Link>
            <a href="#" className="rounded-full border border-emerald-600/50 bg-transparent px-4 py-2 text-nav font-medium text-emerald-800 no-underline transition-colors hover:bg-emerald-100">Contact us</a>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-px overflow-hidden rounded-[10px] border border-black/[0.08] bg-black/[0.08] md:grid-cols-3 md:items-stretch">
          <div className="flex flex-col bg-[#F9F9F9] p-6">
            <div className="mb-1.5 text-overline font-semibold uppercase tracking-[0.1em] text-[#6b6b68]">Explorer</div>
            <div className="mb-0.5 text-[38px] font-medium leading-none tracking-[-0.03em] text-[#1a1a18] sm:text-[42px]">€49</div>
            <div className="mb-4 text-nav text-[#6b6b68]">/ month</div>
            <div className="mb-4 text-app-secondary text-[#6b6b68]">50 tokens · ~5 reports</div>
            <div className="mb-4 h-px bg-black/[0.08]" />
            <div className="mb-4 text-app-secondary text-[#6b6b68]">For the one-plot buyer. Home buyer · Land buyer · Architect · Realtor</div>
            <div className="flex-1">
              {["50 tokens", "~5 reports", "Basic analysis"].map((f) => (
                <div key={f} className="mb-2 flex items-start gap-2 text-nav leading-snug text-[#6b6b68]">
                  <span className="pf-check" />
                  {f}
                </div>
              ))}
            </div>
            <Link href="/explorer" className="mt-4 block w-full rounded-full border border-black/[0.18] bg-transparent py-2.5 text-center text-nav font-medium text-[#1a1a18] no-underline transition-colors hover:bg-black/[0.05]">Get started</Link>
          </div>
          <div className="plan featured relative flex flex-col bg-[#1a1a18] p-6 text-white">
            <div className="absolute right-4 top-4 rounded-full border border-[#c84b0a]/25 bg-[#c84b0a]/10 px-2 py-0.5 text-overline font-semibold uppercase tracking-[0.08em] text-[#c84b0a]">Most popular</div>
            <div className="mb-1.5 text-overline font-semibold uppercase tracking-[0.1em] text-white/45">Scout</div>
            <div className="mb-0.5 text-[38px] font-medium leading-none tracking-[-0.03em] text-white sm:text-[42px]">€299</div>
            <div className="mb-4 text-nav text-white/40">/ month</div>
            <div className="mb-4 text-app-secondary text-white/40">400 tokens · ~40 reports</div>
            <div className="mb-4 h-px bg-white/10" />
            <div className="mb-4 text-app-secondary text-white/40">For the multi-plot operator. Eco tourism · Hospitality · Land investor · Active agent</div>
            <div className="flex-1">
              {["400 tokens", "~40 reports", "Full constraint layer", "Tracker", "Off-market discovery"].map((f) => (
                <div key={f} className="mb-2 flex items-start gap-2 text-nav leading-snug text-white/55">
                  <span className="pf-check" />
                  {f}
                </div>
              ))}
            </div>
            <Link href="/explorer" className="mt-4 block w-full rounded-full border-none bg-white py-2.5 text-center text-nav font-medium text-[#1a1a18] no-underline">Get started</Link>
          </div>
          <div className="flex flex-col bg-[#F9F9F9] p-6">
            <div className="mb-1.5 text-overline font-semibold uppercase tracking-[0.1em] text-[#6b6b68]">Pro</div>
            <div className="mb-0.5 text-[38px] font-medium leading-none tracking-[-0.03em] text-[#1a1a18] sm:text-[42px]">€999</div>
            <div className="mb-4 text-nav text-[#6b6b68]">/ month</div>
            <div className="mb-4 text-app-secondary text-[#6b6b68]">2,000 tokens · ~200 reports</div>
            <div className="mb-4 h-px bg-black/[0.08]" />
            <div className="mb-4 text-app-secondary text-[#6b6b68]">For the at-scale player. Project developer · Solar & energy · Data center · Land bank</div>
            <div className="flex-1">
            ...
            <a href="#" className="mt-4 block w-full rounded-full border border-black/[0.18] bg-transparent py-2.5 text-center text-nav font-medium text-[#1a1a18] no-underline transition-colors hover:bg-black/[0.05]">Talk to us</a>
          </div>
        </div>
        <p className="mt-5 text-center text-nav text-[#6b6b68]">
      ...
      <footer className="py-12 lg:py-16">
        <div className="mb-4 text-body font-medium text-[#1a1a18]">
          Find land. Know land. The land operating system for Europe.
        </div>
        <div className="mb-6 text-nav text-[#6b6b68]">
          <a href="https://liveyonder.co" className="text-[#c84b0a] no-underline hover:text-[#a63d08]">liveyonder.co</a>
          {" · © 2025"}
        </div>
        <div className="flex flex-wrap gap-x-10 gap-y-5">
          <div>
            <div className="mb-1.5 text-overline font-semibold uppercase tracking-[0.1em] text-[#6b6b68]">Product</div>
            <div className="flex flex-col gap-1">
              <Link href="/explorer" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">Search land</Link>
              <Link href="/explorer" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">Browse cadastre</Link>
              <Link href="/explorer" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">Draw search</Link>
              <Link href="/explorer" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">Reports</Link>
            </div>
          </div>
          <div>
            <div className="mb-1.5 text-overline font-semibold uppercase tracking-[0.1em] text-[#6b6b68]">Company</div>
            <div className="flex flex-col gap-1">
              <a href="#" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">About</a>
              <a href="#" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">Partners</a>
              <a href="#pricing" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">Pricing</a>
              <a href="#" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">Blog</a>
            </div>
          </div>
          <div>
            <div className="mb-1.5 text-overline font-semibold uppercase tracking-[0.1em] text-[#6b6b68]">Contact</div>
            <div className="flex flex-col gap-1">
              <a href="mailto:hello@liveyonder.co" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">hello@liveyonder.co</a>
              <a href="#" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">LinkedIn</a>
              <a href="#" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">Privacy</a>
              <a href="#" className="text-nav text-[#6b6b68] no-underline transition-colors hover:text-[#c84b0a]">Terms</a>
            </div>
          </div>
        </div>
      </footer>
